// ==UserScript==
// @name         KS Torn War Dibs WSE PC
// @namespace    kingshade.torn
// @version      0.1.0
// @description  PC TEST: DIBS as a native roster column beside Torn's Attack cell while War Stuff Enhanced 2.1 runs; FF and Est from FFScouter's get-stats API.
// @author       Kingshade
...
(() => {
  ...
  const SCRIPT = Object.freeze({
    name: "KS Torn War Dibs WSE PC",
    version: "0.1.0",
    instanceKey: "__ksTornWarDibsWsePcV010",
    ...
    secureVaultRollbackCipherId: "wseSharedApiCipherRollbackV1",
    ...
    tornCustomKeyUrl: "https://www.torn.com/preferences.php#tab=api?step=addNewKey&title=KS%20Torn%20War%20Dibs%20WSE%20PC&faction=members,wars&user=basic"
  });
  ...
  function applyPanelMinimizedState(host) {
    ...
    if (toggle instanceof HTMLButtonElement) {
      ...
      toggle.setAttribute("aria-label", panelMinimized ? "Expand KS Torn War Dibs WSE PC panel" : "Minimize KS Torn War Dibs WSE PC panel");
  ...
  function ensurePanel() {
    ...
    shadow.innerHTML = `
      ...
      <div class="panel">
        <div class="top"><span class="brand">KS Torn War Dibs WSE PC</span><span class="compact-brand" data-role="compact-brand">KS DIBS WSE</span><span class="compact-status" data-role="compact-status"><span class="dot"></span><span data-role="compact-status-text">WAIT</span></span><span class="top-actions"><span class="version">v${SCRIPT.version} TEST</span><button class="panel-toggle" type="button" data-role="panel-toggle" aria-expanded="true">Minimize</button></span></div>
