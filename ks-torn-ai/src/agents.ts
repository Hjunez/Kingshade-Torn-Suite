...
import type { KsTornAiConfig } from './config.js';
import { KS_TORN_AI_SYSTEM_PROMPT } from './prompt.js';

function researchTools(config: KsTornAiConfig) {
  const tools = [
    webSearchTool({
