...
export const ALLOWED_SYNTHETIC_DEBUG_TRANSITIONS: StateTransitionMap = Object.freeze({
  ...
  EVIDENCE_READY: Object.freeze({
    ...
    RECORD_READ_ONLY_ROOT_CAUSE: 'EVIDENCE_READY',
    MARK_DEFECT_REFERENCE_READY: 'BASELINE_READY',
    MARK_DEFECT_REFERENCE_AND_ROOT_CAUSE_READY: 'ROOT_CAUSE_READY',
    BLOCK: 'BLOCKED',
    FAIL: 'FAILED',
  }),
