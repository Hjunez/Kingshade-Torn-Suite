...
(() => {
    ...
    /*
     * Kingshade's Bootlegging v4.1.1
     *
    ...
    const SCRIPT = Object.freeze({
        name: "Kingshade's Bootlegging Clean",
        version: '4.1.1',
        styleId: 'ks-boot-clean-v411-styles',
    ...
    function render() {
        ...
        /*
         * Always remove every old marker before drawing the current one.
         * SELL has priority and no COPY marker may remain visible with it.
         */
        clearCurrentMarkers();

        if (instruction.mode === 'sell') {
            renderSellHighlight(instruction);
        } else if (instruction.mode === 'copy') {
